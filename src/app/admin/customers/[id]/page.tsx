...
export default function AdminCustomerDetailPage() {
  ...
  if (error || !customer) {
    return (
      <div>
        <Button variant="ghost" size="sm" href="/admin/customers" className="mb-4">
  ...
  return (
    <div>
      <Button variant="ghost" size="sm" href="/admin/customers" className="mb-6">
        &larr; Back to Customers
      </Button>
          ...
          {editing ? (
            ...
            <dl className="space-y-3">
              ...
              <div>
                ...
                <dd className="text-sm font-medium text-gray-900">{customer.totalBookings}</dd>
              </div>
              <div>
                <dt className="text-sm text-gray-500">Completed Bookings</dt>
                <dd className="text-sm font-medium text-gray-900">{customer.completedBookings}</dd>
              </div>
              <div>
